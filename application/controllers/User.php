...
class User extends CI_Controller {
        ...
        public function complete()
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $register_check = array('logged_in' => true) ;
                ...
                $this->session->set_userdata($register_check) ;
        ...
        public function login()
        {
            ...
            if($this->form_validation->run() == FALSE) {
                ...
                $login_check = array('logged_in' => true) ;
                if(!$userInfo){
                ...
                $this->session->set_userdata($login_check) ;
                redirect(site_url().'/main/main_page');
            }
...
//                'user_id'=>$user_info->id,
        ...
        public function edit_user()
        {
          ...
          $this->load->view('users/update_user') ;
          }
