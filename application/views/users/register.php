<div class="container animate-fadein">
    ...
    <?php
        ...
        echo form_open_multipart('/user/register', $fattr); ?>
        ...
        <div class="form-group">
          <?php echo form_upload(array('name'=>'profile_picture', 'id'=> 'profile_picture', 'placeholder'=>'Profile Picture', 'class'=>'form-control', 'value'=> set_value('profile_picture'))); ?>
