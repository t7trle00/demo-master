...
<div id="results" class="listing_detail animate-left" style="font-size:1.25em">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <select name="type_of_car" style="width:100px; height:35px;">
          ...
          <?php
              if($id_get_edit[0]['type_of_car'] == "Coupe")
              {
              ...
              else if($id_get_edit[0]['type_of_car'] == "Diesel")
              {
                echo '<option value="Coupe">Coupe</option>
                      <option value="Truck">Truck</option>
                      <option value="SUV">SUV</option>
                      <option value="Sedans">Sedans</option>
                      <option value="Sport car">Sport car</option>' ;
              }
              if($id_get_edit[0]['type_of_car'] == "Truck")
              {
                echo '<option value="Coupe">Coupe</option>
              ...
              if($id_get_edit[0]['type_of_car'] == "SUV")
              {
                echo '<option value="Coupe">Coupe</option>
                      <option value="Truck">Truck</option>
                      <option value="Diesel">Diesel</option>
              ...
              if($id_get_edit[0]['type_of_car'] == "Sedans")
              {
                echo '<option value="Coupe">Coupe</option>
                      <option value="Truck">Truck</option>
                      <option value="SUV">SUV</option>
              ...
              if($id_get_edit[0]['type_of_car'] == "Sport car")
              {
                echo '<option value="Coupe">Coupe</option>
                      <option value="Truck">Truck</option>
                      <option value="SUV">SUV</option>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <a class ="btn btn-primary" href="<?php echo site_url('host_controller/get_listing_update/').$userID?>">CANCEL</a>
      </div>
      <br><br>
    </div>
  </div>
