...
class Password {
	...
	//	$salt = base64_encode(mcrypt_create_iv(self::PBKDF2_SALT_BYTE_SIZE, MCRYPT_DEV_URANDOM)); <-- Unfortunately this function is depracated and removed in php 7.2
	// and I could not use the alternative in the students server. The way of hashing it right now is bad, but it was a last minute change.
	$salt = base64_encode(PBKDF2_SALT_BYTE_SIZE);
